...
public class CatalogoLivros {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "A sua pesquisa por autor teve o seguinte resultado: " + catalogoLivros.pesquisarPorAutor("selia"));
        System.out.println("A sua pesquisa por intervalo teve o seguinte resultado: "
                + catalogoLivros.pesquisarPorIntervaloAnos(2003, 2007));
        System.out.println("A sua pesquisa por titulo teve o seguinte resultado: "
                + catalogoLivros.pesquisarPorTitulo("TELEKINESEs"));
